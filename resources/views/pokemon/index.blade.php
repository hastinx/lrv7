...
<head>
    ...
    <link  rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
      <link  rel="stylesheet" href="{{ secure_asset('assets/select2.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('assets/select2-bootstrap4.min.css') }}" >
...
<script src="{{ secure_asset('assets/pokemon.js') }}"></script>
