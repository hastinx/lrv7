...
<head>
    ...
    <link  rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
      <link  rel="stylesheet" href="{{ secure_asset('assets/select2.min.css') }}" type="text/css">
    ...
    <script src="{{ secure_asset('assets/select2.full.min.js') }}" type="application/javascript"></script>
</head>
<script>
...
<script src="{{ secure_asset('assets/pokemon.js') }}" type="application/javascript"></script>
