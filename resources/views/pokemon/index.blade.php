...
<head>
    ...
    <link  rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
      <link  rel="stylesheet" href="{{ asset('assets/select2.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/select2-bootstrap4.min.css') }}"  type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/style.css') }}" type="text/css">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <link rel="shortcut icon" href="{{ asset('assets/pokeball.png') }}" type="image/png"/>
    <script src="{{ asset('assets/jquery.js') }}" type="application/javascript"></script>
    <script src="{{ asset('assets/jquery.min.js') }}" type="application/javascript"></script>
    <script src="{{asset('assets/bootstrap.bundle.min.js') }}" type="application/javascript"></script>
    <script src="{{ asset('assets/select2.full.min.js') }}" type="application/javascript"></script>
</head>
<script>
...
<script src="{{ asset('assets/pokemon.js') }}" type="application/javascript"></script>
